...
Public Class RPT_HistoryPiutang
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Best_POS.RPT_HistoryPiutang.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRPT_HistoryPiutang
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As RPT_HistoryPiutang = New RPT_HistoryPiutang()
        rpt.Site = Me.Site
        Return rpt
    End Function
