...
Public Class RPT_Faktur_Penjualan2
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "RPT_Faktur_Penjualan2.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Best_POS.RPT_Faktur_Penjualan2.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRPT_Faktur_Penjualan2
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As RPT_Faktur_Penjualan2 = New RPT_Faktur_Penjualan2()
        rpt.Site = Me.Site
        Return rpt
    End Function
