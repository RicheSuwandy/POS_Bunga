Public Class FRM_Alokasi_Barang_Pembelian
    Dim awalg1, awalg2, akhirg1, akhirg2, totalqty, selisihg1, selisihg2 As Decimal
    Dim kodebarang As String
    Private Sub FRM_Alokasi_Barang_pembelian_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        cfgAlokasi.AllowEditing = False
        'TODO: This line of code loads data into the 'Db_POS_CNDataSet.Query_Alokasi_pembelian' table. You can move, or remove it, as needed.
        Me.Query_Alokasi_PembelianTableAdapter.FillByKodePembelian(Me.Db_POS_CNDataSet.Query_Alokasi_Pembelian, FRM_Pembelian.txtKodePembelian.Text)
    End Sub

    Private Sub FRM_Alokasi_Barang_pembelian_FormClosed(ByVal sender As System.Object, ByVal e As System.Windows.Forms.FormClosedEventArgs) Handles MyBase.FormClosed
        Me.Dispose()
    End Sub
    ...
    Private Sub cfgAlokasi_AfterEdit(ByVal sender As System.Object, ByVal e As C1.Win.C1FlexGrid.RowColEventArgs) Handles cfgAlokasi.AfterEdit
        Try
            ...
            Else
                ...
                selisihg1 = akhirg1 - awalg1
                selisihg2 = akhirg2 - awalg2
                TbL_BarangTableAdapter.UpdateQtyG1(selisihg1, kodebarang)
                TbL_BarangTableAdapter.UpdateQtyG2(selisihg2, kodebarang)
                TbL_Alokasi_PembelianTableAdapter.UpdateG1G2(akhirg1, akhirg2, FRM_Pembelian.txtKodePembelian.Text, kodebarang)
            End If
