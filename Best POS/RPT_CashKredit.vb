...
Public Class RPT_CashKredit
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Best_POS.RPT_CashKredit.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_JenisPenjualan() As CrystalDecisions.[Shared].IParameterField
        Get
...
Public Class CachedRPT_CashKredit
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As RPT_CashKredit = New RPT_CashKredit()
        rpt.Site = Me.Site
        Return rpt
    End Function
