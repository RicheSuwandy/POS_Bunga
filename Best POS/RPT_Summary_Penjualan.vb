...
Public Class RPT_Summary_Penjualan
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "RPT_Summary_Penjualan.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Best_POS.RPT_Summary_Penjualan.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_JenisLaporan() As CrystalDecisions.[Shared].IParameterField
        Get
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_BulanLaporan() As CrystalDecisions.[Shared].IParameterField
        Get
...
Public Class CachedRPT_Summary_Penjualan
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As RPT_Summary_Penjualan = New RPT_Summary_Penjualan()
        rpt.Site = Me.Site
        Return rpt
    End Function
