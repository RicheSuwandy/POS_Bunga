...
Public Class RPT_LabaKotor
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Best_POS.RPT_LabaKotor.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRPT_LabaKotor
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As RPT_LabaKotor = New RPT_LabaKotor()
        rpt.Site = Me.Site
        Return rpt
    End Function
