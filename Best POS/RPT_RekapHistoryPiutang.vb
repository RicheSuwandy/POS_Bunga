...
Public Class RPT_RekapHistoryPiutang
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "RPT_RekapHistoryPiutang.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Best_POS.RPT_RekapHistoryPiutang.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRPT_RekapHistoryPiutang
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As RPT_RekapHistoryPiutang = New RPT_RekapHistoryPiutang()
        rpt.Site = Me.Site
        Return rpt
    End Function
