...
Partial Class FRM_RPTTagihan
    ...
    Private Sub InitializeComponent()
        ...
        Me.VwRptTagihanTableAdapter = New Best_POS.db_POS_CNDataSetTableAdapters.VwRptTagihanTableAdapter()
        ...
        '
        'VwRptTagihanTableAdapter
        '
        Me.VwRptTagihanTableAdapter.ClearBeforeFill = True
        '
        'FRM_RPTTagihan
        '
        ...
        Me.Name = "FRM_RPTTagihan"
        Me.Text = "Form Laporan Tagihan"
    ...
    Friend WithEvents VwRptTagihanTableAdapter As Best_POS.db_POS_CNDataSetTableAdapters.VwRptTagihanTableAdapter
End Class
