...
Public Class RPT_Retur_Jual
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Best_POS.RPT_Retur_Jual.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRPT_Retur_Jual
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As RPT_Retur_Jual = New RPT_Retur_Jual()
        rpt.Site = Me.Site
        Return rpt
    End Function
