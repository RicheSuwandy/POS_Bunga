...
Public Class RPT_Barang_Detail
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Best_POS.RPT_Barang_Detail.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRPT_Barang_Detail
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As RPT_Barang_Detail = New RPT_Barang_Detail()
        rpt.Site = Me.Site
        Return rpt
    End Function
