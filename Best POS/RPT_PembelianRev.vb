...
Public Class RPT_PembelianRev
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Best_POS.RPT_PembelianRev.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRPT_PembelianRev
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As RPT_PembelianRev = New RPT_PembelianRev()
        rpt.Site = Me.Site
        Return rpt
    End Function
